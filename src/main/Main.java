        ...
        while (!status) {
            ...
            switch (adminChoice) {
                ...
                case 3 -> {
                    ...
                    String username = input.nextLine();
                    if (admin.checkAccountExist(username)) {
                        Accounts account = admin.getAccount(username);
                        if (account != null) {
                            System.out.println("===================");
                            System.out.println(username + "'s Information:");
                            account.displayAccountInfo(); // Display account details
                            System.out.println("===================");
                        } else {
                            System.out.println("Error: Account exists but couldn't be retrieved.");
                        }
                    } else {
